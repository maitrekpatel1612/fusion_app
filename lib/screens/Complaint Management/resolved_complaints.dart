...
class ViewResolved extends StatefulWidget {
  const ViewResolved({Key? key}) : super(key: key);

  @override
  State<ViewResolved> createState() => _ViewResolvedState();
}

class _ViewResolvedState extends State<ViewResolved> {
