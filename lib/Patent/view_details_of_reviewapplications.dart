...
import '../utils/sidebar.dart'; // Importing custom Sidebar
import '../utils/gesture_sidebar.dart'; // Importing Gesture Sidebar
import '../utils/bottom_bar.dart'; // Importing custom BottomBar

void main() {
  runApp(MaterialApp(
    debugShowCheckedModeBanner: false,
    home: ViewDetailsOfReviewApplications(),
  ));
}

class ViewDetailsOfReviewApplications extends StatelessWidget {
